...
class SCAPP_0():
    ...
    def set_result_file_0(self, result_file=None):
        if result_file is not None:
            ...
            raise SCAPP_0_Error("The result_file is None.")
    ...
    def data_input_0(self, filepath=None, species=None, tissue=None):
        if filepath is not None:
            if filepath[-6:] == "tsv.gz":
                self.obj = sc.read_umi_tools(filepath)
            if filepath[-6:] == "mtx.gz":
                self.obj = sc.read_10x_mtx(filepath[:-13], var_names='gene_symbols', cache=False)
        ...
        if self.obj is not None:
            ...
            raise SCAPP_0_Error("The expression matrix is not successfully loaded.")

    def batch_data_input_0(self, filepaths=None, species=None, tissues=None):
        if filepaths is None:
            raise SCAPP_0_Error("The filepaths are None.")
        for i in filepaths:
            if i[-6:] == "tsv.gz":
                self.objs.append(sc.read_umi_tools(i))
            if i[-6:] == "mtx.gz":
                self.objs.append(sc.read_10x_mtx(i[:-13], var_names='gene_symbols', cache=False))
        if species is not None:
            for i in species:
                self.batch_species.append(i)
        if tissues is not None:
            for i in tissues:
                self.batch_tissues.append(i)
        if self.objs is None:
            raise SCAPP_0_Error("The expression matrices are not successfully loaded.")

    def data_input_0_from_anndata(self, anndata=None):
        if anndata is not None:
            self.obj = anndata
        else:
            raise SCAPP_0_Error("The anndata is None.")
    ...
    def batch_data_input_0_and_concat_0(self, filepaths=None, species=None, tissues=None):
        pass
    ...
    def make_marker_gene_list_0(self,flag = None):
        if flag is None:
            flag = 2
        ref1 = open('./plant_marker_gene_list.txt', 'r', encoding='utf-8')
        dir_gene_species = {}
            ...
            for line in ref1:
                ...
                if len(line.split('\t')) >= 5:
                    ...
                    if gene in dir_gene_organ_celltype:
                        dir_gene_organ_celltype[gene] = dir_gene_organ_celltype[
                                                            gene] + ' / ' + 'organ: ' + organ + '  ' + 'celltype: ' + celltype
                    else:
    ...
    def annotation_with_marker_gene_list_0(self):
        dir_gene_species, dir_gene_organ_celltype = self.make_marker_gene_list_0(flag = 2)
        count_1 = 0
        count_2 = 0
        anno_re = []
        ...
        dir_gene_species, dir_gene_organ_celltype = self.make_marker_gene_list_0(flag = 1)
    ...
    def to_clusters_0(self, verbosity=None, dpi=None, facecolor=None, # set_default_0
            filepath=None, species=None, tissue=None, # batch_data_input_0
        ...
        self.data_input_0(filepath=filepath, species=species, tissue=tissue)
        self.filter_0()
    ...
    def batch_to_clusters_0(self, verbosity=None, dpi=None, facecolor=None, # set_default_0
            filepaths=None, species=None, tissues=None, # batch_data_input_0
            n_top=None, num_min_genes=None, num_max_genes=None, num_min_cells=None, # filter_0
                max_percent_of_specific_genes=None,
                genelist=None, mad_coeffcient=None,
            norm_target_sum=None, hvg_min_mean=None, hvg_max_mean=None,  # norm_log_hvg_filter_regress_scale_0
            ...
            pca_svd_algorithm=None, pca_genelist=None, # pca_cluster_markerSelect_0
                ...
                markerSelect_n_genes=None, show_n=None):
        self.set_default_0(verbosity=verbosity, dpi=dpi, facecolor=facecolor)
        self.batch_data_input_0(filepaths=filepaths, species=species, tissues=tissues)
        self.concat_0()
    ...
    def to_annotation_0(self, verbosity=None, dpi=None, facecolor=None, # set_default_0
            species=None,filepath=None,tissue=None,filepaths=None,tissues=None, # batch_data_input_0
            n_top=None, num_min_genes=None, num_max_genes=None, num_min_cells=None, # filter_0
                max_percent_of_specific_genes=None,
                genelist=None, mad_coeffcient=None,
            norm_target_sum=None, hvg_min_mean=None, hvg_max_mean=None,  # norm_log_hvg_filter_regress_scale_0
        ...
        if filepath is not None:
            self.to_clusters_0(verbosity=verbosity, dpi=dpi, facecolor=facecolor, # set_default_0
                filepath=filepath, species=species, tissue=tissue, # batch_data_input_0
        ...
        if filepaths is not None:
            ...
            self.batch_to_clusters_0(verbosity=verbosity, dpi=dpi, facecolor=facecolor, # set_default_0
                filepaths=filepaths, species=species, tissues=tissues, # batch_data_input_0
                n_top=n_top, num_min_genes=num_min_genes, num_max_genes=num_max_genes, # filter_0
                    num_min_cells=num_min_cells, 
                    max_percent_of_specific_genes=max_percent_of_specific_genes,
                    genelist=genelist, mad_coeffcient=mad_coeffcient,
